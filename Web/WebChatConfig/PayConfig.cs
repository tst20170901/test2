...
namespace WebChatConfig
{
    public class PayConfig
    {
        ...
        static PayConfig()
        {
            MchId = AliceDAL.IniHelper.GetValue("WeiXinInfo", "MchId");
            AppId = AliceDAL.IniHelper.GetValue("WeiXinInfo", "AppId");
            AppSecret = AliceDAL.IniHelper.GetValue("WeiXinInfo", "AppSecret");
            AppKey = AliceDAL.IniHelper.GetValue("WeiXinInfo", "AppKey");
        }
